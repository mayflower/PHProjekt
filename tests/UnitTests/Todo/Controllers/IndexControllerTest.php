 ...
 */
class Todo_IndexController_Test extends PHPUnit_Framework_TestCase
{
    ...
    public function testJsonList()
    {
        ...
        $request->setBaseUrl($config->webpath.'index.php/Todo/index/jsonList');
        $request->setPathInfo('/Todo/index/jsonList');
        $request->setRequestUri('/Todo/index/jsonList');
