if(!dojo._hasResource["dojox.form.FileInputOverlay"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["dojox.form.FileInputOverlay"] = true;
