...
$lang["Content Help"]["Project"] = "<br />
    ...
    <ul>
        ...
        <li><b>The tree:</b> the tree panel at the left permits accessing to the Projects and Subprojects in a full
            ...
            exclusively associated to that Project (or Subproject) clicked in the tree.<br />
    </ul>
    <br />
...
$lang["Content Help"]["Basic data"] = "<br />
    ...
    <br/>
    <ul>
    <li><b>Title</b>: title of the Project
    <li><b>Notes</b>: notes about the Project.
    ...
    <li><b>End Date</b>
    <li><b>Priority</b>
    <li><b>Status</b>: may be one of the following: Offered, Ordered, Working, Ended, Stopped, Re-Opened and Waiting.
    <li><b>Percentage completed</b>
    <li><b>Budget</b>
    <li><b>Contact</b>: contacts list from Contact module for you to choose one
    <li><b>Tag</b>
    </ul>
    <br />
    <br />";
...
$lang["Content Help"]["Role"] = "<br />
    ...
    Notes:<br/>
    <ul>
    <li>Each Role scope is defined by Admin users in Administration module.
    <li>Important: when a Project doesn't have any Roles defined, then it inherits its parent Roles.
    <li>Roles don't affect top right linked Global modules like Calendar, Contact, etc.
    </ul>
    <br />
    <br />";
