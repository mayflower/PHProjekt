...
dojo.declare("phpr.Module.Form", phpr.Core.DialogForm, {
    ...
    destroy: function() {
        if (moduleDesignerElements) {
            ...
            moduleDesignerElements = undefined;
    ...
    updateDesignerData: function(event) {
        ...
        var tableName;
        if (self.id > 0) {
            tableName = self.convertLabelIntoTableName(dijit.byId('name').get('value'));
        } else {
            tableName = self.convertLabelIntoTableName(dijit.byId('label').get('value'));
    ...
    convertLabelIntoTableName: function(value) {
        // summary:
        //    Transform the label into a valid DB name
        // description:
        //    Transform the label into a valid DB name
