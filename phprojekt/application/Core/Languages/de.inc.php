...
$lang["Done"] = "Fertig";
$lang["upgrade_errorMessage_server"] = "Auf dem Server ist ein Problem aufgetreten. Sie können die Migration erneut probieren, aber wir können momentan nicht garantieren dass die Datenbank intakt geblieben ist.";
$lang["upgrade_errorMessage"] = "Es gab ein Problem während des Upgrade-Vorgangs. Wir konnten die Datenbank jedoch in einen konsistenten Zustand zurückversetzen. Bitte überprüfen sie die Logfiles für mehr Informationen zum Problem.";
$lang["upgrade_errorMessage_fatal"] = "Es tut uns sehr leid, aber die Migrationsroutine hat ihre Datenbank in einen inkonsistenten Zustand versetzt. Bitte spielen sie ihre Backups ein und überprüfen sie die Logfiles für mehr Informationen über das aufgetretene Problem.";
