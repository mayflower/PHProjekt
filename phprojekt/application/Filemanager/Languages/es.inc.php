...
$lang["Content Help"]["Archivo"] = "<br />
    ...
    <br />
    El módulo Archivos está hecho exclusivamente para subir y bajar archivos del sistema.<br />
    <br />
    Se puede agregar más de un archivo en un solo ítem de módulo, con descripción, categoría, etc.<br />
    <br />
    <br />";
