    ...
    style="position: absolute; top: 55px; left: 16%; width: 100%;">
        ...
        style="width: 84%; height: 100%;">
            ...
            <div dojoType="dijit.layout.ContentPane" region="center" id="centerMainContent">
                <form dojoType="dijit.form.Form" id="loginForm" name="frm" method="post" action="setup.php"
                        onsubmit="return validateForm();">
                <table width="100%" align="center" class="form">
                <col class="col1" />
                    <tr>
                        <td style="padding: 0 0 4px 5px;" class="label"><label for="server_type">Server type</label></td>
                        <td style="padding: 0 0 4px 5px;">
                            <select name="server_type"><%SERVER_TYPE%></select>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 0 0 4px 5px;" class="label"><label for="server_host">Database server:</label></td>
                        <td style="padding: 0 0 4px 5px;">
                            <input dojoType="dijit.form.TextBox" type="text" name="server_host" value="<%SERVER_HOST%>" />
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 0 0 4px 5px;" class="label"><label for="server_user">Database username:</label></td>
                        <td style="padding: 0 0 4px 5px;">
                            <input dojoType="dijit.form.TextBox" type="text" name="server_user" value="<%SERVER_USERNAME%>" />
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 0 0 4px 5px;" class="label"><label for="server_password">Database password:</label></td>
                        <td style="padding: 0 0 4px 5px;">
                            <input dojoType="dijit.form.TextBox" type="password" name="server_pass" value="<%SERVER_PASS%>" />
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 0 0 4px 5px;" class="label"><label for="server_database">Database name:</label></td>
                        <td style="padding: 0 0 4px 5px;">
                            <input dojoType="dijit.form.TextBox" type="text" name="server_database" value="<%SERVER_DATABASE%>" />
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 0 0 4px 5px;" class="label"><label for="admin_pass">Admin user pass:</label></td>
                        <td style="padding: 0 0 4px 5px;">
                            <input dojoType="dijit.form.TextBox" type="password" name="admin_pass" value="" />
                        </td>
                    <tr>
                    <tr>
                        <td style="padding: 0 0 4px 5px;" class="label"><label for="admin_pass_confirm">Admin pass confirm:</label></td>
                        <td style="padding: 0 0 4px 5px;">
                            <input dojoType="dijit.form.TextBox" type="password" name="admin_pass_confirm" value="" />
                        </td>
                    <tr>
                    <tr>
                        <td class="label"><h3>Migration</h3></td>
                        <td>Please, provide the path to the config.inc.php file of your old PHProjekt 5.x.<br />
                            <u>Notes</u>:<br />
                            <ul>
                    ...
                    <tr>
                        <td class="label">
                            <button dojoType="dijit.form.Button" baseClass="positive" id="submitButton" type="submit" iconClass="tick">
                            Install
                            </button>
                        </td>
                        <td>&nbsp;</td>
