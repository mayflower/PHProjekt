<?php
/**
 * Test suite for the Timeproj module
 *
...
class Timeproj_AllTests
{
    ...
    {
        $suite = new PHPUnit_Framework_TestSuite('Timeproj Controller');

        $suite->addTestSuite('Timeproj_IndexController_Test');
...
if (PHPUnit_MAIN_METHOD == 'Timeproj_AllTests::main') {
